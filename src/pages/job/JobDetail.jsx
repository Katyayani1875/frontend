        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          >
            <div className="sticky top-24 space-y-6">
              ...
              {/* Using the new, professional button styles */}
              <div className="bg-white dark:bg-gray-800/50 backdrop-blur-md border border-gray-200 dark:border-gray-700/50 rounded-2xl shadow-xl p-6 space-y-3">
                <button 
                  className="btn-shine w-full disabled:opacity-75 disabled:cursor-not-allowed" 
                  onClick={handleApply} 
                  disabled={applying || hasApplied}
                >
                  {hasApplied ? (
                    <span className="flex items-center justify-center"><CheckCircle size={20} className="mr-2"/> Applied</span>
                  ) : (
