...
import {
  ...
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-RWE2QUEV.js";
import {
  composeRefs,
  useComposedRefs
} from "./chunk-RQHZVDCJ.js";
import {
  require_react_dom
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime6.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React21.Children.map(children, (child) => (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime6.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var he = t.forwardRef((r, o) => {
  ...
  return t.createElement(Primitive2.div, { ref: composeRefs(u2, o), ...q, id: n, "cmdk-item": "", role: "option", "aria-disabled": !!A, "aria-selected": !!R, "data-disabled": !!A, "data-selected": !!R, onPointerMove: A || d.getDisablePointerSelection() ? void 0 : S, onClick: A ? void 0 : C }, r.children);
});
...
var Ce = t.forwardRef((r, o) => {
  ...
  }, []), t.createElement(Primitive2.div, { ref: composeRefs(d, o), ...c, "cmdk-list": "", role: "listbox", tabIndex: -1, "aria-activedescendant": p2, "aria-label": u2, id: b.listId }, B2(r, (m2) => t.createElement("div", { ref: composeRefs(f, b.listInnerRef), "cmdk-list-sizer": "" }, m2)));
});
